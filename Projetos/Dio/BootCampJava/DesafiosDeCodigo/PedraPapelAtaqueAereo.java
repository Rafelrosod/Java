    ...
    public static void main(String[] args) {
      	try (Scanner leitor = new Scanner(System.in)) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                else if (jogador2.equalsIgnoreCase("ataque") && jogador1.equalsIgnoreCase("ataque")) System.out.println("Aniquilacao mutua");
                ...
                else if (jogador2.equalsIgnoreCase("pedra") && jogador1.equalsIgnoreCase("ataque")) System.out.println("Jogador 1 venceu");
